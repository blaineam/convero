...
} else if(strtolower($_GET['preset']) == "imessage") {
	echo PHP_EOL."Using preset: " . strtolower($_GET['preset']);
	$_GET['format'] = "gif";
	$_GET['resolution'] = 618;
	$_GET['filesize'] = 500 * 1024;
}else if(strtolower($_GET['preset']) == "imessage-medium") {
	echo PHP_EOL."Using preset: " . strtolower($_GET['preset']);
	$_GET['format'] = "gif";
	$_GET['resolution'] = 408;
	$_GET['filesize'] = 500 * 1024;
}else if(strtolower($_GET['preset']) == "imessage-small") {
	echo PHP_EOL."Using preset: " . strtolower($_GET['preset']);
	$_GET['format'] = "gif";
	$_GET['resolution'] = 300;
	$_GET['filesize'] = 500 * 1024;
}else if(strtolower($_GET['preset']) == "giphy") {
	echo PHP_EOL."Using preset: " . strtolower($_GET['preset']);
	$_GET['format'] = "gif";
	$_GET['resolution'] = 512;
	$_GET['filesize'] = 1024 * 1024;
}else if(strtolower($_GET['preset']) == "tenor") {
	echo PHP_EOL."Using preset: " . strtolower($_GET['preset']);
	$_GET['format'] = "gif";
	$_GET['resolution'] = 512;
	$_GET['filesize'] = 512 * 1024;
}else if(strtolower($_GET['preset']) == "discord") {
	echo PHP_EOL."Using preset: " . strtolower($_GET['preset']);
	$_GET['format'] = "apng";
	$_GET['resolution'] = 320;
	$_GET['filesize'] = 512 * 1024;
}else if(strtolower($_GET['preset']) == "discord-emoji") {
	echo PHP_EOL."Using preset: " . strtolower($_GET['preset']);
	$_GET['format'] = "gif";
	$_GET['resolution'] = 128;
	$_GET['filesize'] = 256 * 1024;
